...
export default function DownloadApp() {
  ...
  useEffect(() => {
    ...
    base44.functions.invoke('getApkDownload', {})
  ...
  const handleDownloadApk = async () => {
    if (apkInfo?.downloadUrl) {
      ...
      toast.info('APK download link is not set up yet. Please use the PWA install method or contact Prince for the APK file.');
    }
  };
